...
const SkillIcon = ({ src, name }: Props) => {
  return (
    <div className="text-2xl relative bg-bg-secondary bg-white shadow-md dark:shadow-xl rounded-full h-14 w-14 sm:h-16 sm:w-16 grid place-items-center group">
